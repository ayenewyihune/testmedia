        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6 offset-md-3">
                    <form action="/dashboard/spt/create" method="POST">
                        {{ csrf_field() }}
                        <br><br><br>
                        <h4 class="text-center">Enter Number of Records</h4>
                        <p class="text-center">(Number of records is the number of SPT readings made
                            per one borehole. Please make sure to specify it correctly.)</p>
